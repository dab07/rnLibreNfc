...
function Main(props) {
  return (
    <MainStack.Navigator
      ...
      screenOptions={{
        header: ({ navigation, scene, previous }) => {
          ...
          if (excludedScreens.findIndex((name) => name === scene?.route?.name) > -1) {
            return null;
          }
    ...
    >
      ...
      <MainStack.Screen name="TagDetail" options={{ title: "TAG DETAIL" }} component={TagDetailScreen} />
      <MainStack.Screen name="NdefTypeList" component={NdefTypeListScreen} options={{ title: "CHOOSE NDEF TYPE" }} />
      <MainStack.Screen name="NdefWrite" component={NdefWriteScreen} options={{ title: "WRITE NDEF" }} />
      <MainStack.Screen name="ToolKit" component={ToolKitScreen} options={{ title: "NFC TOOL KIT" }} />
      ...
      />
      <MainStack.Screen name="SavedRecord" component={SavedRecordScreen} options={{ title: "MY SAVED RECORDS" }} />
    </MainStack.Navigator>
  );
}
...
function Settings(props) {
  return (
    ...
    >
      <SettingsStack.Screen name="Settings" options={{ title: "Settings" }} component={SettingsScreen} />
    </SettingsStack.Navigator>
  );
}
